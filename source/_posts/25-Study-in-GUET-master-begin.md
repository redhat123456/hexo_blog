...
在这里，我遇见了改变我大学生活的钥匙：Github。这个神奇的网站不仅让我的页面通过 Github-page 在以太网上绽放，更向我打开了 hexo 博客系统和 md 语法的新世界。作为一个代码小白，我像解读古代楔形文字般艰难地啃着每一行指令。

大一下学期那个炎热的暑假，基地主席的要求如同悬在头顶的达摩克利斯之剑：提交原创作品才能留下。我异想天开地想将克苏鲁神话改编成 Unity 游戏，却在引擎的复杂面前败下阵来。最终，我在网上找到一个基础程序，像拼图般将其改造成我想要的模样。记得当我对着 300 行天书般的 C 语言代码手足无措时，学长的回答简单却充满力量："慢慢看，都能看懂的。"
